...
public class GymHall {
    ...
    public ArrayList<GymClass> classesOffered; //List to store classesOffered
    public ArrayList<Trainer> trainers; //List to store trainers
    public ArrayList<GymMembers> members;  // List to store members
